...
app.post("/search", async function(req, res) {
    ...
    // const found = await Component.find({ name: name })

    // console.log(found)
    // res.send(found)

    // const found = await Component.find({});
    // console.log(found);
...
// app.get('/user/643567981a101324f0504999', (req, res) => {
//     const user = { name: 'Suyash', admin: true };
